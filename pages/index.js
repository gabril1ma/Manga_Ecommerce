  ...
  return (
    <div>
        ...
        <section id="header"> <a> <Link href="/"><img src="/imagens/logo.png" className="logo" width={100} height={100} /></Link></a>
          <div>
            <ul id="navbar">
              <Link href="/"><li><a class='active'>Home</a></li></Link>
        ...
        <section id="hero">
          ...
          <h1>Com os melhores preços do mercado</h1>
          <Link href="/full"><button>lista completa de produtos</button></Link>
        </section>
        ...
        <section id="banner" className="section-m1">
          <h2>Todos principais titulos com os <span>melhores preços</span></h2>
        ...
        <section id="sm-banner" className="section-p1">
          <div className="banner-box">
            <Link href="../full"><button className="white">Ver coleção</button></Link>
          </div>
          <div className="banner-box banner-box2">
            <Link href="../full"><button className="white white2">Ver coleção</button></Link>
          </div>
        </section>
